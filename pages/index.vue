<template>
  <v-layout column justify-center align-center>
    <v-flex xs12 sm8 md6>
      ...
      <v-card>
        <v-card-title class="headline">My name is Nick I am Sick</v-card-title>
        <v-card-text>
          <p>Vuetify is a progrsive Material Design component framework for Vue.js. It was designed to empower developers to create amazing applications.</p>
        ...
        <v-card-actions>
          <v-spacer></v-spacer>
          <v-btn color="primary" flat nuxt to="/about">About</v-btn>
        </v-card-actions>
      </v-card>
    </v-flex>
  </v-layout>
